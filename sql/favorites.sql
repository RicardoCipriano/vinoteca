...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/11/2025 às 21:38
...
ALTER TABLE `favorites`
  ADD PRIMARY KEY (`user_id`,`wine_id`),
...
ALTER TABLE `favorites`
  ...
  ADD CONSTRAINT `favorites_ibfk_2` FOREIGN KEY (`wine_id`) REFERENCES `wines` (`id`) ON DELETE CASCADE;
COMMIT;
